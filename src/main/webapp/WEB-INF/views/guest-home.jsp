...
<html lang="en">
<head>
    <link rel="stylesheet" href="/css/incoming_1.css">
    <meta charset="utf-8">
    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="pages-rent-warehouse.jsp">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="pages-login.jsp">
                        <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Sign In</span>
                    </a>
                </li>

                <li class="sidebar-item">
                    <a class="sidebar-link" href="pages-registerForm.jsp">
    ...
    <div class="main">
        ...
        <div class="incoming-container">
            ...
            <table class="incoming_table">
                ...
                <tbody>
                <tr onclick="selectProduct(this, 'PRD001')">
                    <td>PRD001</td>
                    <td>냉장고</td>
                    <td>가전</td>
                    <td>180</td>
                ...
                <tr onclick="selectProduct(this, 'PRD002')">
                    <td>PRD002</td>
                    <td>세탁기</td>
                    <td>가전</td>
                    <td>150</td>
                ...
                <tr onclick="selectProduct(this, 'PRD003')">
                    <td>PRD003</td>
                    <td>에어컨</td>
                    <td>가전</td>
                    <td>200</td>
        ...
        <script>
            ...
            function goToNext() {
                if (selectedProductId) {
                    window.location.href = 'pages-incoming-quantity.html';
                }
            }
        </script>
