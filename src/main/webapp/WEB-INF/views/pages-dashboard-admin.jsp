                    ...
                    <div class="col-sm-6 col-xl-3 d-flex">
                        <div class="card flex-fill">
                            ...
                            <div class="card-body d-flex flex-column align-items-start justify-content-center"
                                 style="height: 140px;"><h2 class="mb-1">2.382</h2>
                                <p class="mb-0">-3.65% Since last week</p></div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3 d-flex">
                        <div class="card flex-fill">
                            <div class="card-header"><h5 class="card-title mb-0">Earnings</h5></div>
                            <div class="card-body d-flex flex-column align-items-start justify-content-center"
                                 style="height: 140px;"><h2 class="mb-1">$21.300</h2>
                                <p class="mb-0 text-success">+6.65% Since last week</p></div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3 d-flex">
                        <div class="card flex-fill">
                            <div class="card-header"><h5 class="card-title mb-0">New Orders</h5></div>
                            <div class="card-body d-flex flex-column align-items-start justify-content-center"
                                 style="height: 140px;"><h2 class="mb-1">856</h2>
                                <p class="mb-0 text-warning">+1.12% Since yesterday</p></div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3 d-flex">
                        <div class="card flex-fill">
                            <div class="card-header"><h5 class="card-title mb-0">Conversion Rate</h5></div>
                            <div class="card-body d-flex flex-column align-items-start justify-content-center"
                                 style="height: 140px;"><h2 class="mb-1">18.7%</h2>
                                <p class="mb-0 text-danger">-0.42% vs last period</p></div>
                        </div>
                    </div>
                </div>
                <div class="row">
