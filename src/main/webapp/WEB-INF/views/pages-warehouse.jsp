        ...
        <div class="container">
            ...
            <script>
                ...
                const positions = [
                    ...
                    {
                        id: '${wh.warehouse_id}',                           // 창고 ID
                        name: '${wh.warehouse_name}',                       // 창고 이름
                        location: '${wh.location}',                         // 주소
                        ratio: '${wh.FAR}%',                                // FAR 에 % 붙이기
                        area: '${wh.width}㎡',                              // 예시: width 를 면적으로 사용

                        status: '사용가능',                                  // DB에 상태 컬럼이 없으면 모두 사용가능 처리
                        latlng: new kakao.maps.LatLng(
                            ${37.279518 + loop.index * 0.2},
                            ${127.442226 + loop.index * 0.2}
                        )
